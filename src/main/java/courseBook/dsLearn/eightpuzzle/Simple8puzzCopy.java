package courseBook.dsLearn.eightpuzzle;

import java.util.ArrayList;
import java.util.List;
import java.util.PriorityQueue;

public class Simple8puzzCopy {	public int dimension = 3;
    ...
    public static void main(String[] args) {
        ...
        Simple8puzzCopy puzzle = new Simple8puzzCopy();
        if (puzzle.isSolvable(initial)) {
            puzzle.solve(initial, end, x, y);
        }
        else {
